...
let problems = [
	...
	},
	{
		"title": "AM-GM",
		"description": "Fun",
		"typst": String.raw`(x_1 + x_2 + dots.h + x_n)/n >= root(n, x_1 dot x_2 dots.h x_n)`
	},
	{
	...
	},
	{
		...
		"description": "Classic",
		"typst": String.raw`phi = sqrt(1 + sqrt(1 + sqrt(1 + sqrt(1 + dots.h))))`
	},
	{
	...
	},
	{
		...
		"description": "G = g_{64}",
		"typst": String.raw`g_n = cases(3 arrow.t arrow.t arrow.t arrow.t 3 quad & n = 1, 3 arrow.t^(g_(n-1)) 3 quad & n >= 2 and n in NN)`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`a^p equiv a (mod p)`
	},
	{
		"title": "Euler's Theorem",
		"description": "totients",
		"typst": String.raw`gcd(a, n) = 1 => a^(phi(n)) equiv 1 (mod n)`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`m = c^(e^(-1) mod phi.alt(n)) (mod n)`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`a_1 <= a_2 <= dots.h <= a_n, b_1 <= b_2 <= dots.h <= b_n => sum_(i=1)^n a_i b_i >= sum_(i=1)^n a_(sigma(i)) b_i >= sum_(i=1)^n a_(n+1-i) b_i`
	},
	{
		"title": "Power Mean",
	...
	},
	{
		...
		"typst": String.raw`binom(n, 0) + binom(n, 1) + binom(n, 2) + dots.h + binom(n, n) = 2^n`
	},
	{
		"title": "Alternating Harmonic Series",
		"description": "First use of ln",
		"typst": String.raw`1 - 1/2 + 1/3 - 1/4 + 1/5 - dots.h = ln 2`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`integral_0^oo sin(x)/x dot sin(x/3)/(x/3) dots.h dot sin(x/13)/(x/13) "d"x = pi/2`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`f(n) = cases(n/2 quad & n equiv 0 (mod 2), 3n + 1 quad & n equiv 1 (mod 2))`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`F_(n+1) = binom(n, 0) + binom(n-1, 1) + binom(n-2, 2) + dots.h + binom(n - floor(n/2), floor(n/2))`
	},
	{
	...
	},
	{
		...
		"typst": String.raw`L(phi, theta; x) = EE_(z ~ q_phi (dot | x)) [ln (p_theta (x,z))/(q_phi (z | x))]`
	},
	{
