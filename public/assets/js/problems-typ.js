let problems = [
  {
    ...
    "description": "Classic.",
    "typst": "x = (-b plus.minus sqrt(b^2 - 4 a c))/(2 a)"
  },
  {
    "title": "Pythagorean Theorem",
    "description": "Classic.",
    "typst": "c = sqrt(a^2+b^2)"
  },
  {
  ...
  },
  {
    ...
    "description": "Classic.",
    "typst": "c^2 = a^2 + b^2 - 2 a b cos angle C"
  },
  {
    "title": "Legendre's formula",
    "description": "Floors.",
    "typst": "nu_p (n!) = sum_(i = 1)^oo floor(n/p^i)"
  },
  {
  ...
  },
  {
    ...
    "description": "Troll.",
    "typst": "ceil(e) - floor(pi) = 0"
  },
  {
    "title": "Normal Distribution",
    "description": "Thanks to Martin for correcting this!",
    "typst": "Phi(x) = 1/(sigma sqrt(2 pi)) e^(-(x - mu)^2/(2 sigma^2))"
  },
  {
    "title": "Fourier Transform",
    "description": "17 Equations That Changed the World.",
    "typst": "hat(f)(omega) = integral_(-oo)^oo f(x) e^(-2 pi i x omega) \"d\"x"
  },
  {
    "title": "Wave Equation",
    "description": "17 Equations That Changed the World.",
    "typst": "(partial^2 u)/(partial t^2) = c^2 (partial^2 u)/(partial x^2)"
  },
  {
    "title": "Navier-Stokes Equation",
    "description": "17 Equations That Changed the World.",
    "typst": "rho ((partial bold(\"v\"))/(partial t) + bold(\"v\") dot nabla bold(\"v\")) = -nabla p + nabla dot bold(\"T\") + bold(\"f\")"
  },
  {
    "title": "Schrodinger's Equation",
    "description": "17 Equations That Changed the World.",
    "typst": "i planck (partial)/(partial t) Psi = H Psi"
  },
  {
    "title": "Black-Scholes Equation",
    "description": "17 Equations That Changed the World.",
    "typst": "frac(partial V, partial t) + frac(1, 2) sigma^2 S^2 frac(partial^2 V, partial S^2) + r S frac(partial V, partial S) - r V = 0"
  },
  {
    "title": "Relativity",
    "description": "17 Equations That Changed the World.",
  ...
  },
  {
    "title": "Chaos Theory",
    "description": "17 Equations That Changed the World.",
    "typst": "x_(t+1) = k x_t (1 - x_t)"
  },
  {
    "title": "Definition of the Derivative",
    "description": "17 Equations That Changed the World.",
    "typst": "(\"d\"f)/(\"d\"x) = lim_(h -> 0) (f(x + h) - f(x))/h"
  },
  {
  ...
  },
  {
    "title": "Gravitation",
    "description": "17 Equations That Changed the World.",
    "typst": "F = (G m_1 m_2)/d^2"
  },
  {
    "title": "AM-GM",
    "description": "Fun",
    "typst": "frac(x_1 + x_2 + dots.h.c + x_n, n) >= root(n, x_1 dot x_2 dots.h.c x_n)"
  },
  {
    "title": "Stirling's Approximation",
    "description": "Fun",
    "typst": "n! approx sqrt(2 pi n) (n/e)^n"
  },
  {
    "title": "Stokes' Theorem",
    "description": "Fun",
    "typst": "integral.double_S (nabla times bold(\"F\")) dot \"d\"bold(\"S\") = integral.cont_Gamma bold(\"F\") dot \"d\"bold(Gamma)"
  },
  {
    "title": "Divergence Theorem",
    "description": "Fun",
    "typst": "integral.triple_V (nabla dot bold(\"F\")) \"d\"V = integral.surf_S (bold(\"F\") dot bold(\"n\")) \"d\"S"
  },
  {
    "title": "Cauchy-Schwarz Inequality",
    "description": "Fun",
    "typst": "abs(chevron.l bold(\"u\") comma bold(\"v\") chevron.r)^2 <= chevron.l bold(\"u\") comma bold(\"u\") chevron.r dot chevron.l bold(\"v\") comma bold(\"v\") chevron.r"
  },
  {
  ...
  },
  {
    ...
    "description": "Simple.",
    "typst": "a^4 + 4 b^4 = (a^2 + 2 a b + 2 b^2)(a^2 - 2 a b + 2 b^2)"
  },
  {
    "title": "Pascal's Identity",
    "description": "Classic.",
    "typst": "binom(n, k) = binom(n-1, k) + binom(n-1, k-1)"
  },
  {
    "title": "Hockey-stick Identity",
    "description": "Classic.",
    "typst": "sum_(i=r)^n binom(i, r) = binom(n+1, r+1)"
  },
  {
    "title": "Vandermonde's Identity",
    "description": "Classic.",
    "typst": "binom(m + n, r) = sum_(k = 0)^r binom(m, k) binom(n, r-k)"
  },
  {
    "title": "Combinations",
    "description": "Simple.",
  ...
  },
  {
    ...
    "typst": "frac(1, sqrt(z - cos psi)) = frac(sqrt(2), pi) sum_(m = -oo)^oo Q_(m - frac(1, 2))(z) e^(i m psi)"
  },
  {
    "title": "Binomial identity",
    "description": "Classic.",
    "typst": "(x + y)^n = sum_(k=0)^n binom(n, k) x^(n-k) y^k"
  },
  {
    "title": "Hermite's Identity",
    "description": "Hadn't heard of this either.",
    "typst": "sum_(k=0)^(n-1) floor(x + k/n) = floor(n x)"
  },
  {
    "title": "Matrix Determinant Lemma",
    "description": "Or this lmao.",
    "typst": "det(bold(\"A\") + bold(\"u\") bold(\"v\")^top) = (1 + bold(\"v\")^top bold(\"A\")^(-1) bold(\"u\")) det(bold(\"A\"))"
  },
  {
    "title": "Euler Product of the Riemann-Zeta function",
    "description": "Classic.",
    "typst": "zeta(s) = sum_(n=1)^oo 1/n^s = product_(p in PP) 1/(1 - p^(-s))"
  },
  {
    "title": "Irrationality of the Square Root of 2",
    "description": "I just really wanted to keep using bb.",
    "typst": "sqrt(2) in.not QQ"
  },
  {
    "title": "Heron's Formula",
    "description": "Classic.",
    "typst": "bracket.l triangle.stroked.t A B C bracket.r = sqrt(s(s-a)(s-b)(s-c))"
  },
  {
    "title": "Heisenberg's Uncertainty Principle",
    "description": "Classic.",
    "typst": "Delta x Delta p approx planck"
  },
  {
    "title": "Continued Fraction for pi/2",
    "description": "@InertialObservr",
    "typst": "frac(pi, 2) = 1 + frac(1, 1 + frac(1, frac(1, 2) + frac(1, frac(1, 3) + frac(1, frac(1, 4) + dots.down))))"
  },
  {
    "title": "Sophomore's Dream",
    "description": "Cool.",
    "typst": "integral_0^1 x^(-x) \"d\"x = sum_(n=1)^oo n^(-n)"
  },
  {
    "title": "Identity involving pi and e",
    "description": "@InertialObservr",
    "typst": "product_(n=2)^oo e (1 - 1/n^2)^(n^2) = pi/(e sqrt(e))"
  },
  {
    "title": "Representation of the Golden Ratio",
    "description": "Classic",
    "typst": "phi.alt = sqrt(1 + sqrt(1 + sqrt(1 + sqrt(1 + dots.h))))"
  },
  {
    "title": "The Sum of all Positive Integers",
    "description": "Troll.",
    "typst": "sum_(n = 1)^oo n = -frac(1, 12)"
  },
  {
    "title": "Inverse of a complex number",
    "description": "Gotta know macron man",
    "typst": "z^(-1) = frac(macron(z), abs(z)^2) comma forall z != 0"
  },
  {
    "title": "Definition of Convolution",
    "description": "Shout out to 6.003",
    "typst": "(f * g)(t) = integral_(-oo)^oo f(tau) g(t - tau) \"d\"tau"
  },
  {
    "title": "Definition of the Kronecker Delta function",
    "description": "cases ftw",
    "typst": "delta_(i comma j) = cases(0 quad & i != j, 1 quad & i = j)"
  },
  {
    "title": "Bayes' Theorem",
  ...
  },
  {
    ...
    "description": "fun",
    "typst": "f(t) = frac(Gamma(frac(nu + 1, 2)), sqrt(nu pi) Gamma(frac(nu, 2))) (1 + frac(t^2, nu))^(-frac(nu + 1, 2))"
  },
  {
    "title": "De Morgan's laws",
    "description": "fun",
    "typst": "not (P and Q) tack.r (not P) or (not Q)"
  },
  {
    "title": "Principle of Inclusion-Exclusion",
    "description": "for dummies",
    "typst": "abs(A union B) = abs(A) + abs(B) - abs(A inter B)"
  },
  {
    "title": "General Principle of Inclusion-Exclusion",
    "description": "for galaxy brains",
    "typst": "abs(union.big_(i = 1)^n A_i) = sum_(emptyset != J subset.eq {1, dots.h, n}) (-1)^(abs(J) + 1) abs(inter.big_(j in J) A_j)"
  },
  {
    "title": "Determinant of a 2 by 2 matrix",
    "description": "matrix",
    "typst": "det mat(delim: \"[\", a, b; c, d) = a d - b c"
  },
  {
    "title": "Sawtooth Function",
    "description": "bb cases floors, this has it all",
    "typst": "S(x) = cases(x - floor(x) - frac(1, 2) quad & x in RR without ZZ, 0 quad & x in ZZ)"
  },
  {
    "title": "Definition of Graham's Number",
    "description": "G = g_{64}",
    "typst": "g_n = cases(3 arrow.t arrow.t arrow.t arrow.t 3 quad & n = 1, 3 attach(arrow.t comma tr colon g_(n-1)) 3 quad & n >= 2 and n in NN)"
  },
  {
    "title": "Burnside's Lemma",
    "description": "The Lemma that is not Burnside's",
    "typst": "abs(X/G) = frac(1, abs(G)) sum_(g in G) abs(X^g)"
  },
  {
    "title": "Continuum Hypothesis",
    "description": "independent of ZFC!",
    "typst": "aleph_0 = abs(NN) comma frak(c) = abs(RR) \\ exists.not A colon aleph_0 < abs(A) < frak(c)"
  },
  {
    "title": "Spectral Decomposition",
    "description": "derived from memory",
    "typst": "A = mat(delim: \"(\", |, |, , |; bold(\"v\")_1, bold(\"v\")_2, dots.h, bold(\"v\")_n; |, |, , |) mat(delim: \"(\", lambda_1, , , ; , lambda_2, , ; , , dots.down, ; , , , lambda_n) mat(delim: \"(\", |, |, , |; bold(\"v\")_1, bold(\"v\")_2, dots.h, bold(\"v\")_n; |, |, , |)^(-1)"
  },
  {
  ...
  },
  {
    ...
    "typst": "sin(2 theta) = 2 sin(theta) cos(theta)"
  },
  {
    "title": "Double Angle for \\cos",
    "description": "back to basics",
    "typst": "cos(2 theta) = cos^2(theta) - sin^2(theta)"
  },
  {
    "title": "Fermat's Last Theorem",
    "description": "have a marvelous proof, but this description's too small to contain it",
    "typst": "exists.not brace.l x comma y comma z comma n brace.r in NN comma n > 2 colon x^n + y^n = z^n"
  },
  {
    "title": "Fermat's Little Theorem",
    "description": "fermat's itty bitty theorem",
    "typst": "a^p equiv a quad (mod p)"
  },
  {
    "title": "Euler's Theorem",
    "description": "totients",
    "typst": "gcd(a, n) = 1 ==> a^(phi(n)) equiv 1 quad (mod n)"
  },
  {
    "title": "QM-AM-GM-HM Inequality over 3 variables",
    "description": "cool-looking",
    "typst": "sqrt(frac(a^2 + b^2 + c^2, 3)) >= frac(a + b + c, 3) >= root(3, a b c) >= frac(3, frac(1, a) + frac(1, b) + frac(1, c))"
  },
  {
    "title": "Extended Law of Sines",
    "description": "threw in the circumradius as well",
    "typst": "a/(sin angle A) = b/(sin angle B) = c/(sin angle C) = 2 R"
  },
  {
    "title": "Integration by Parts",
    "description": "it's just the product rule really",
    "typst": "integral u \"d\"v = u v - integral v \"d\"u"
  },
  {
    "title": "Definition of Perfect Numbers",
    "description": "shrug",
    "typst": "brace.l n colon sum_(d | n)^(d < n) d = n brace.r"
  },
  {
    "title": "Gaussian Integral",
    "description": "classic trick",
    "typst": "integral_(-oo)^oo e^(-x^2) \"d\"x = sqrt(integral_(-oo)^oo integral_(-oo)^oo e^(-x^2 - y^2) \"d\"x \"d\"y) = sqrt(integral_0^(2 pi) integral_0^oo e^(-r^2) r \"d\"r \"d\"theta) = sqrt(pi)"
  },
  {
    "title": "Definition of an Integral",
    "description": "why not",
    "typst": "integral_a^b f(x) \"d\"x = lim_(k -> oo) ((b-a) sum_(i = 1)^k (f(a + i(b-a)/k))/k)"
  },
  {
    "title": "Quantum Fourier transform",
    "description": "bra ket notation is fun",
    "typst": "|x chevron.r |-> 1/sqrt(N) sum_(k = 0)^(N-1) omega_x^k |k chevron.r"
  },
  {
    "title": "Recursive definition of the Hadamard transform",
    "description": "matrix in cases",
    "typst": "H_m = cases(1 quad & m = 0, frac(1, sqrt(2)) mat(delim: \"(\", H_(m-1), H_(m-1); H_(m-1), -H_(m-1)) quad & m > 0)"
  },
  {
    "title": "Wigner Transform of the Density Matrix",
    "description": "I know some of these words",
    "typst": "W(x comma p) = frac(1, pi planck) integral_(-oo)^oo chevron.l x + y | hat(rho) | x - y chevron.r e^(-frac(2 i p y, planck)) \"d\"y"
  },
  {
  ...
  },
  {
    "title": "Sum of Cubes",
    "description": "Simple",
    "typst": "a^3 + b^3 = (a+b)(a^2 - a b + b^2)"
  },
  {
    "title": "RSA Decryption Algorithm",
    "description": "good ol' rivest",
    "typst": "m = c^(e^(-1) mod phi.alt(n)) quad (mod n)"
  },
  {
    "title": "Contraposition",
    "description": "logic yo",
    "typst": "(p ==> q) <==> (not q ==> not p)"
  },
  {
    "title": "Equation of a spring",
    "description": "Gonna use dots like the physicists do",
    "typst": "m dot.double(x) = -k x"
  },
  {
    "title": "Sum of reciprocals of partial sums of N",
    "description": "Credit to @IntertialObservr",
    "typst": "sum_(i = 2)^oo 1/(sum_(j = 1)^i j) = 1"
  },
  {
    "title": "Binet's Formula",
    "description": "Classic",
    "typst": "F_n = 1/sqrt(5) (phi^n - (-1)^n/phi^n)"
  },
  {
    "title": "Sum of first n Cubes",
    "description": "Classic",
    "typst": "sum_(k = 0)^n k^3 = (sum_(k = 0)^n k)^2"
  },
  {
    "title": "The Basel Problem",
    "description": "Classic",
    "typst": "sum_(n = 1)^oo 1/n^2 = pi^2/6"
  },
  {
    "title": "Root Mean Square",
    "description": "how could i forget",
    "typst": "f_\"rms\" = sqrt(1/(T_2 - T_1) integral_(T_1)^(T_2) [f(t)]^2 \"d\"t)"
  },
  {
    "title": "The Harmonic Series",
    "description": "Classic",
    "typst": "sum_(n=1)^oo 1/n = oo"
  },
  {
    "title": "Tupper's Self-Referential Formula",
    "description": "Troll",
    "typst": "frac(1, 2) < floor(mod(floor(frac(y, 17)) 2^(-17 floor(x) - mod(floor(y), 17)), 2))"
  },
  {
    "title": "Hölder's Inequality",
    "description": "Styled like the OTIS handouts by Evan Chen",
    "typst": "(sum_(i = 1)^n a_i)^p (sum_(i = 1)^n b_i)^q >= (sum_(i = 1)^n root(p+q, a_i^p b_i^q))^(p+q)"
  },
  {
    "title": "Rearrangement Inequality",
    "description": "kinda cool",
    "typst": "a_1 <= a_2 <= dots.h.c <= a_n comma b_1 <= b_2 <= dots.h.c <= b_n ==> sum_(i=1)^n a_i b_i >= sum_(i=1)^n a_(sigma(i)) b_i >= sum_(i=1)^n a_(n+1-i) b_i"
  },
  {
    "title": "Power Mean",
    "description": "like RMS-AM-GM-HM but like generalized",
    "typst": "M_r(x_1 comma x_2 comma dots.h comma x_n) = cases((frac(1, n) sum_(i=1)^n x_i^r)^(frac(1, r)) quad & r != 0, root(n, product_(i=1)^n x_i) quad & r = 0)"
  },
  {
    "title": "Law of Tangents",
    "description": "yes this actually exists",
    "typst": "(a-b)/(a+b) = tan((angle A - angle B)/2)/tan((angle A + angle B)/2)"
  },
  {
    "title": "Euler's Arctangent Identity",
    "description": "dammit euler OP",
    "typst": "tan^(-1)(1/x) = tan^(-1)(1/(x+y)) + tan^(-1)(y/(x^2 + x y + 1))"
  },
  {
    "title": "The Dirichlet Convolution",
    "description": "bruh",
    "typst": "(f ast g)(n) = sum_(d|n) f(d) g(n/d)"
  },
  {
    "title": "Sum of a Row of Pascal's Triangle",
    "description": "not sure how else to word it",
    "typst": "binom(n, 0) + binom(n, 1) + binom(n, 2) + dots.h.c + binom(n, n) = 2^n"
  },
  {
    "title": "Alternating Harmonic Series",
    "description": "First use of ln",
    "typst": "1 - 1/2 + 1/3 - 1/4 + 1/5 - dots.h.c = ln 2"
  },
  {
    "title": "Definitions of Catalan's Constant",
    "description": "Credit to /u/heropup",
    "typst": "G = beta(2) = sum_(k=0)^oo frac((-1)^k, (2k+1)^2) = integral.double_(bracket.l 0 comma 1 bracket.r^2) frac(\"d\"x \"d\"y, 1 + x^2 y^2)"
  },
  {
    "title": "Series Representation of Apéry's Constant",
    "description": "Credit to /u/heropup",
    "typst": "zeta(3) = frac(5, 2) sum_(n=1)^oo frac((-1)^(n-1), n^3 binom(2n, n))"
  },
  {
    "title": "Definition of the Euler-Mascheroni Constant",
    "description": "Credit to /u/heropup",
    "typst": "gamma = lim_(n -> oo) (sum_(k=1)^n 1/k - ln n) = integral_1^oo (1/floor(x) - 1/x) \"d\"x"
  },
  {
    "title": "Mertens' therorem",
    "description": "actually his third theorem",
    "typst": "product_(p in PP)^n (1 - 1/p) ~ e^(-gamma)/(log n)"
  },
  {
    "title": "Green's First Identity",
    "description": "Credit to Varge",
    "typst": "integral_Omega (psi Delta phi + nabla psi dot nabla phi) \"d\"V = integral.cont_(partial Omega) psi (nabla phi dot bold(\"n\")) \"d\"S"
  },
  {
    "title": "Cauchy-Riemann Equations",
    "description": "complex analysis is best analysis (1); credit to blu_bird",
    "typst": "frac(partial u, partial x) = frac(partial v, partial y) comma frac(partial u, partial y) = -frac(partial v, partial x)"
  },
  {
    "title": "Cauchy's Integral Formula",
    "description": "complex analysis is best analysis (2); credit to blu_bird",
    "typst": "f(z_0) = frac(1, 2 pi i) integral.cont_Gamma frac(f(z), z-z_0) \"d\"z"
  },
  {
    "title": "Cauchy's Differentiation Formula",
    "description": "complex analysis is best analysis (3); credit to blu_bird",
    "typst": "f^((k))(z_0) = frac(k!, 2 pi i) integral.cont_Gamma frac(f(z), (z-z_0)^(k+1)) \"d\"z"
  },
  {
    ...
    "typst": "pi^(-frac(s, 2)) Gamma(frac(s, 2)) zeta(s) = pi^(-frac(1-s, 2)) Gamma(frac(1-s, 2)) zeta(1-s)"
  },
  {
    "title": "Well-ordering Principle",
    "description": "Classic. Credit to Eucrue",
    "typst": "forall M (M subset NN and M != emptyset ==> exists m_0 [m_0 in M and forall n (n in M ==> m <= n)])"
  },
  {
    "title": "Asymptotic Formula for the Dirichlet Divisor Function",
    "description": "very cool dirichlet",
    "typst": "sum_(n <= x) tau(n) = x log x + (2 gamma - 1) x + O(sqrt(x))"
  },
  {
  ...
  },
  {
    ...
    "typst": "bold(\"i\")^2 = bold(\"j\")^2 = bold(\"k\")^2 = bold(\"i\")bold(\"j\")bold(\"k\") = -1"
  },
  {
    ...
    "typst": "y = e^(-integral P(x) \"d\"x) integral Q(x) e^(integral P(x) \"d\"x) \"d\"x + C e^(-integral P(x) \"d\"x)"
  },
  {
    ...
    "typst": "F_(n+1) = binom(n, 0) + binom(n-1, 1) + binom(n-2, 2) + dots.h.c+ binom(n - floor(n/2), floor(n/2))"
  },
  {
    "title": "Bellman Optimality Equation",
    "description": "Somehow connected to reinforcement learning! Credit to Constantine.",
    "typst": "V^(pi*)(s) = max_a {R(s,a) + gamma sum_(s') P(s'|s,a) V^(pi*)(s')}"
  },
  {
  ...
  },
  {
    ...
    "typst": "frac(1, pi) = 12 sum_(k=0)^oo frac((-1)^k (6k)! (545140134 k + 13591409), (3k)! (k!)^3 (640320)^(3k + frac(3, 2)))"
  },
  {
    "title": "Residue Theorem",
    "description": "Q: Why did the mathematician name her dog Cauchy? A: Because it left a residue at every pole.",
    "typst": "frac(1, 2 pi i) integral.cont_gamma f(z) \"d\"z = sum_(p \"pole\") bold(\"I\")(gamma comma p) \"Res\"(f comma p)"
  },
  {
    "title": "Center of Mass",
    "description": "In a uniform gravitation field, this is the same as the center of gravity.",
    "typst": "bold(\"R\") = 1/M integral.triple_Q rho(bold(\"r\"))bold(\"r\") \"d\"V"
  },
  {
    "title": "The Fundamental Group of the Circle",
    "description": "It's isomorphic to the group of integers. Credit to fish.",
    "typst": "pi_1(S^1) tilde.equiv ZZ"
  },
  {
    "title": "Definition of the Operator Norm on a Finite Dimensional Banach Space.",
    "description": "Credit to Richik Chakraborty.",
    "typst": "brace.l frac(norm(T(x))', norm(x)) colon x != 0 comma x in X brace.r equiv brace.l norm(T(x))' colon norm(x) = 1 comma x in X brace.r"
  },
  {
    "title": "Green's Theorem",
    "description": "Credit to Facejo.",
    "typst": "integral.cont_C (L \"d\"x + M \"d\"y) = integral.double_D ((partial M)/(partial x) - (partial L)/(partial y)) \"d\"x\"d\"y"
  },
  {
    ...
    "typst": "sigma^2_z = (sum_(i=1)^n w^2_i sigma^2_i) + 2 (sum_(i=1)^(n-1) sum_(j = i+1)^n w_i w_j sigma_(i, j))"
  },
  {
    "title": "Newton's Method",
    "description": "Credit to https://github.com/lucasalavapena.",
    "typst": "x_(n+1) = x_n - f(x_n)/(f'(x_n))"
  },
  {
    "title": "Shannon Entropy",
    "description": "Credit to https://github.com/lucasalavapena.",
    "typst": "H(X) = -sum_(i=1)^n P(x_i) log_2 P(x_i)"
  },
  {
    "title": "Pinsker's inequality",
    "description": "It's possible I'm off by a factor of two here.",
    "typst": "norm(mu - nu)_\"TV\" <= sqrt(2 D_\"KL\" (mu||nu))"
  },
  {
    "title": "Sackur-Tetrode equation",
    "description": "Entropy of monatomic ideal gas. Credit to Haydn Gwyn.",
    "typst": "frac(S, k_B N) = ln(frac(V, N) (frac(4 pi m, 3 h^2) frac(U, N))^(frac(3, 2))) + frac(5, 2)"
  },
  {
    ...
    "typst": "H(Y|X) = -sum_(x in cal(X) comma y in cal(Y)) p(x comma y) log(frac(p(x comma y), p(x)))"
  },
  {
    ...
    "typst": "bold(\"F\") = -(partial U)/(partial x) hat(bold(\"i\")) - (partial U)/(partial y) hat(bold(\"j\")) - (partial U)/(partial z) hat(bold(\"k\")) = -arrow(nabla)(U)"
  },
  {
    "title": "Beta Function",
    ...
    "typst": "B(x comma y) = integral_0^1 t^(x-1) (1-t)^(y-1) \"d\"t"
  },
  {
    ...
    "typst": "Gamma_\"w\" = -(\"d\"T)/(\"d\"z) = g ((1 + (H_\"v\" r)/(R_\"sd\" T)))/((c_\"pd\" + (H_\"v\"^2 r)/(R_\"sw\" T^2)))"
  },
  {
    "title": "Cardano's Formula",
    "description": "Solution for a depressed cubic. Credit to TetanicRain7592.",
    "typst": "root(3, -frac(q, 2) + sqrt(frac(q^2, 4) + frac(p^3, 27))) + root(3, -frac(q, 2) - sqrt(frac(q^2, 4) + frac(p^3, 27)))"
  },
  {
